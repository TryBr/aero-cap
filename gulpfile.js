...
gulp.task('js', ['common-js'], function () {
	return gulp.src([
        ...
        'app/libs/pushy-menu/pushy.min.js',
...
gulp.task('filesmin', function () {
	return gulp.src('app/files/**/*')
		// .pipe(cache(filesmin())) // Cache Images
		.pipe(imagemin())
		.pipe(gulp.dest('dist/files'));
});

gulp.task('build', ['removedist', 'imagemin', 'filesmin', 'sass', 'js'], function () {
